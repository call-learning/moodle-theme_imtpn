...
$string['murpedagoenabled_desc'] = 'Activer mur pedagogique';
$string['murpedagoenabled'] = 'Activer mur pedagogique';
$string['murpedagogique'] = 'Mur pédagogique';
$string['murpedagogrouprules_desc'] = 'Les règles affichées sur chaque group pour les participants.';
$string['murpedagogrouprules'] = 'Les règles affichées sur chaque group pour les participants.';
...
$string['theme/imtpn:mpaviewallgroups'] = 'Voir tous les groupes sur le Mur pedagogique';
$string['theme/imtpn:canselfjoingroup'] = 'Peut se joindre à un groupe sur le Mur pedagogique';
$string['theme/imtpn:editcataloguethemes'] = 'Peut éditer la page de liste de Themes (Catalogue)';
