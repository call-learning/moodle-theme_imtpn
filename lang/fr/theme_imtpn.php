...
$string['imtpn:mpaviewallgroups'] = 'Voir tous les groupes sur le Mur pedagogique';
$string['imtpn:canselfjoingroup'] = 'Peut se joindre à un groupe sur le Mur pedagogique';
